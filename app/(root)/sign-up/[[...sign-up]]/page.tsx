...
const Page = () => {
  ...
  return (
      <div className='flex flex-col-reverse border-box py-20 md:flex-row min-h-screen w-full bg-gradient-to-br from-purple-100 via-pink-100 to-red-100 dark:from-neutral-700 dark:via-slate-500 dark:to-gray-500'>
          ...
          >
              <div>
                  <motion.h1 variants={itemVariants} className='text-5xl font-bold mb-6'>Join My Profile</motion.h1>
                  <motion.p variants={itemVariants} className='text-2xl mb-8'>Create an account to explore:</motion.p>
          ...
          <div className='w-full md:w-1/2 flex flex-col gap-5 items-center justify-center '>
            ...
            <p className="text-neutral-800 dark:text-neutral-100 space-x-1">Already have an account?<Link className="text-blue-500 dark:text-pink-200 text-sm ml-1 hover:underline" href={'/sign-in'}>Sign In</Link></p>
          </div>
      </div>
  )
}
